...
if(strcmp(channelModel,"UMa"))
    ...
    if(duplexing =="TDD")
        ...
        scs=input("Enter valid scs for TDD: ");
        bandwidth=input("Enter valid bandwidth for corresponding scs: ");
    elseif(duplexing=="FDD")
        gNB_ant_config=[16 16];
        scs=input("Enter valid scs for FDD: ");
        bandwidth=input("Enter valid bandwidth for corresponding scs: ");
    end
elseif(strcmp(channelModel,"RMa"))
...
% Define number of users and their positions
...
simulationLogFile = "simulationLogs_TDD_10MHZ_15KHZ_UMa_10";

% Specify the directory to save the graphs
saveDirectory = "C:\Users\Benie Jaison\Desktop\Cell_Performance_study_1000\Graphs";
...
if enableTraces_partial_phy
    ...
    simulationLogs_TDD_10MHZ_15KHZ_UMa_10{1} = logInfo;
    desktopPath = "C:\Users\Benie Jaison\Desktop\Cell_Performance_study_1000";
    filePath = fullfile(desktopPath, 'simulationLogs_FDD_10MHZ_15KHZ_UMa_10.mat');
    save(filePath, 'simulationLogs_TDD_10MHZ_15KHZ_UMa_10');
end
